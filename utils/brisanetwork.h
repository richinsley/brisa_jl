 ...
 */
BRISA_UTILS_EXPORT bool isLoopbackIPv4Address(QString address);

/*!
 *  Verify if this address is a loopback ipv6 address or not.
 *  \param address \a The address to be tested
 */
BRISA_UTILS_EXPORT bool isLoopbackIPv6Address(QString address);

/*!
 *  Verify if this address is a Promiscous ipv4 address or not.
 *  \param address \a The address to be tested
 */
BRISA_UTILS_EXPORT bool isPromiscuousIPv4Address(QString address);

/*!
 *  Verify if this address is a Promiscous ipv6 address or not.
 *  \param address \a The address to be tested
 */
BRISA_UTILS_EXPORT bool isPromiscuousIPv6Address(QString address);
 ...
 */
BRISA_UTILS_EXPORT bool isPortOpen(QString address, qint16 port, qint16 timeout = 2);
