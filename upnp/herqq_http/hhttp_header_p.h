...
//
class BRISA_UPNP_EXPORT HHttpHeader
{
...
//
// The design and implementation of this class were heavily influenced by
// the Qt's HHttpResponseHeader. The main reason this class exists is
// that Qt has deprecated HHttpResponseHeader.
//
class BRISA_UPNP_EXPORT HHttpResponseHeader :
    public HHttpHeader
{
private:
...
//
// The design and implementation of this class were heavily influenced by
// the Qt's HHttpRequestHeader. The main reason this class exists is
// that Qt has deprecated HHttpRequestHeader.
//
class BRISA_UPNP_EXPORT HHttpRequestHeader :
    public HHttpHeader
{
