...
public:
    ...
    BrisaAbstractService(const QString &serviceType, const QString &serviceId =
            ...
            const QString &eventSubUrl = "", const QString &host = "", const QString &vendorDomainName = "upnp-org",
            QObject *parent = 0);
    /*!
     * \internal
     *
...
protected:
    ...
    // jl - all for defining vendor domain name (ie upnp-org)
    QString vendorDomainName;
