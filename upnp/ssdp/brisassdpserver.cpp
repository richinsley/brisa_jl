...
void BrisaSSDPServer::msearchReceived(HHttpRequestHeader *datagram,
                                     ...
                                     const QString &usn)
{
    ...
    qDebug() << "BrisaSSDPServer writing msearch response for " << senderIp << ":" << senderPort << " location: " << location;
}
